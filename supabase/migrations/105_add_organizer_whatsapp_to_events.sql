ALTER TABLE public.events ADD COLUMN IF NOT EXISTS organizer_whatsapp TEXT;
COMMENT ON COLUMN public.events.organizer_whatsapp IS 'WhatsApp de contato do responsável pelo evento';
