-- 119_hotfix_offerings_category.sql
-- Fix: exclude registration payments from "ofertas" (income_offerings) sum
-- financial_entries stores registration payments as type='income', category='registration'

-- ============================================================
-- 1) get_dashboard_kpis — CTE off: exclude registration payments
-- ============================================================
...
-- ============================================================
-- 2) get_financial_summary — CTE off: same fix
-- ============================================================
