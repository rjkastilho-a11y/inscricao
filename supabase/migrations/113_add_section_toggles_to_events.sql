-- ==============================================================
-- Kairós Events — Controle modular de seções do Hotsite
-- Migration: 113_add_section_toggles_to_events
--
-- Adiciona toggles de exibição das seções "Sobre o Evento" e
-- "Inscrições" no hotsite público.
-- ==============================================================
...
SELECT e.id, e.church_id, c.name AS church_name,
       ...
       e.title, e.subtitle, e.slug, e.description,
